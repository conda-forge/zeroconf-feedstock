...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/zeroconf-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7752&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/zeroconf-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `zeroconf` can be installed with:

```
conda install zeroconf
```

It is possible to list all of the versions of `zeroconf` available on your platform with:
